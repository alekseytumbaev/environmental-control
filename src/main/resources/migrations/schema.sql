...
ALTER TABLE "Company" ADD CONSTRAINT "PK_Company" PRIMARY KEY ("PK_Company")
;
...
ALTER TABLE "Type_Company" ADD CONSTRAINT "PK_Type_Company" PRIMARY KEY ("PK_Type_Company")
;
...
ALTER TABLE "Founders" ADD CONSTRAINT "PK_Founders" PRIMARY KEY ("PK_Founders")
;
...
ALTER TABLE "Type_Company-Company" ADD CONSTRAINT "PK_Type_Company-Company" PRIMARY KEY ("PK_Type_Company","PK_Company")
;
...
ALTER TABLE "ResponsibleSotrud" ADD CONSTRAINT "PK_ResponsibleSotrud" PRIMARY KEY ("PK_ResponsibleSotrud")
;
...
ALTER TABLE "Device" ADD CONSTRAINT "PK_Device" PRIMARY KEY ("PK_Device")
;
...
ALTER TABLE "LogWater" ADD CONSTRAINT "PK_LogWater" PRIMARY KEY ("PK_LogWater")
;
...
ALTER TABLE "LogGas" ADD CONSTRAINT "PK_LogGas" PRIMARY KEY ("PK_LogGas")
;
...
ALTER TABLE "PollutionGases" ADD CONSTRAINT "PK_PollutionGases" PRIMARY KEY ("PK_PollutionGases")
;
...
ALTER TABLE "SensorGas" ADD CONSTRAINT "PK_SensorGas" PRIMARY KEY ("PK_SensorGase")
;
...
ALTER TABLE "SensorWater" ADD CONSTRAINT "PK_SensorWater" PRIMARY KEY ("PK_SensorWater")
;
...
ALTER TABLE "Brand" ADD CONSTRAINT "PK_Brand" PRIMARY KEY ("PK_Brand")
;
